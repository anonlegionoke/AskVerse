    ...
    return (
        <main className="flex flex-col w-full h-screen max-h-dvh px-4 sm:px-6" style={{ backgroundColor: 'var(--background)' }}>
            ...
            <header className="p-4 w-full max-w-5xl mx-auto mt-2 flex justify-between items-center">
                <div>
                    <h1 className="text-4xl font-bold" style={{ color: 'var(--text-primary)' }}><img src="/askverse-icon-minimal.png" alt="AskVerse" className="inline-block w-14 h-14 -ml-2" style={{ filter: isDarkMode ? 'invert(1)' : 'none' }} /> AskVerse</h1>
